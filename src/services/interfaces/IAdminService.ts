export interface IAdminService {
    ...
    editCategory(category: { name: string; description: string }, categoryId: string): Promise<any>;
    getCourseReviewRequests(page: number, limit: number): Promise<any>;
    rejectCourseReviewRequest(rejectReason: string, courseId: string): Promise<any>;
